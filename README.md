[![Build Status](https://gitlab.com/canyan/rating-tester/badges/master/pipeline.svg)](https://gitlab.com/canyan/rating-tester/pipelines)
[![codecov](https://codecov.io/gh/canyanio/rating-tester/branch/master/graph/badge.svg)](https://codecov.io/gh/canyanio/rating-tester)
[![Go Report Card](https://goreportcard.com/badge/github.com/canyanio/rating-tester)](https://goreportcard.com/report/github.com/canyanio/rating-tester)
[![Docker pulls](https://img.shields.io/docker/pulls/canyan/rating-tester.svg?maxAge=3600)](https://hub.docker.com/repository/docker/canyan/rating-tester)

# Canyan Rating: tester
...
Canyan Rating is designed as a microservice architecture and comprises [several repositories](https://github.com/canyanio). Its components are stateless and easily deployable via containers on-premises or in the cloud. This repository contains the Canyan Rating tester.
